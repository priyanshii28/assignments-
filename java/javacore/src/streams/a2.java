...
public class a2 {
    ...
    public static void main(String[] args) {
        ...
        feb23.add(new News(2, "Priyanshi", "rajesh", "comment"));
        feb23.add(new News(3, "ravindra", "ajay", "budget"));
        feb23.add(new News(2, "shivansh", "shivansh", "budget "));
        feb23.add(new News(1, "shivansh", "Priyanshi", "costly"));
        feb23.add(new News(3, "Priyanshi", "ajay", "costly"));
